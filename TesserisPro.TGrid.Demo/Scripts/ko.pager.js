(function (ko) {
    ...
    function Pager(totalItemCount, currentPage, pageSize, pageSlide) {
        var self = this;
    ...
    ko.pager = function (totalItemCount, currentPage, pageSize, pageSlide) {
        var pager = new Pager(totalItemCount, currentPage, pageSize, pageSlide);
